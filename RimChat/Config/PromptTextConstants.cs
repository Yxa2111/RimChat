 ...
 ///</summary>
    internal static class PromptTextConstants
    {
        ...
        public const string RequestRaidCallEveryoneActionRequirement =
            "Use when the faction decides to organize a high-intensity coordinated assault. Obey the global cooldown and runtime faction checks.";
        ...
        public const string RequestRaidWavesActionRequirement =
            "Faction cooldown is 5 days. Use when the faction decides that a sustained multi-wave attack is appropriate.";
        ...
        public const string StrictJsonFormatTemplateWithAction = "{\n  \"visible_dialogue\":\"外交发言文本\",\n  \"actions\":[\n    {\"action\":\"request_item_airdrop\",\"parameters\":{\"need_items\":[{\"item\":\"WoodLog\",\"count\":1000}],\"payment_items\":[{\"item\":\"Silver\",\"count\":1200}]}}\n  ]\n}";
